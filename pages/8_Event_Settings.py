...
# ==========================================
# 🔄 क्लाउड सिङ्क्रोनाइजेसन (Database Sync)
# ==========================================
st.markdown("<hr>", unsafe_allow_html=True)
st.subheader("☁️ डाटाबेस सिङ्क्रोनाइजेसन (Cloud ➡️ Local)")
st.info("💡 यो सुविधाले क्लाउड (Neon DB) मा पालिकाहरूले अनलाइन दर्ता गरेको डाटालाई तानेर तपाईंको लोकल कम्प्युटर (अफलाइन सर्भर) मा सुरक्षित गर्छ।")

with st.expander("⚠️ डाटा सिङ्क (Data Pull) मेनु खोल्नुहोस्", expanded=False):
    st.warning("""
    **🚨 अत्यन्तै महत्त्वपूर्ण:** यो बटन प्रतियोगिता सुरु हुनुभन्दा १ दिन अगाडि (अनलाइन दर्ता बन्द भएपछि) मात्र थिच्नुहोस्। 
    यसले तपाईंको लोकल डाटाबेसका पुराना रेकर्डहरूलाई मेटाएर क्लाउडको नयाँ डाटाले 'Replace' गर्छ।
    """)
    
    if st.button("⬇️ ☁️ → 💻 क्लाउडबाट सम्पूर्ण डाटा तान्नुहोस् (Pull Data)", width="stretch", type="primary"):
        with st.spinner("क्लाउडबाट खेलाडीको डाटा लोकल डाटाबेसमा तानिँदैछ... कृपया ब्राउजर बन्द नगर्नुहोस्..."):
            from utils.sync_db import pull_cloud_to_local
            success, message = pull_cloud_to_local()
            if success:
                st.success(message)
                st.balloons()
            else:
